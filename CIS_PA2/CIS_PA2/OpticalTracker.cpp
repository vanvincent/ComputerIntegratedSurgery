...
int OpticalTracker::read(string filename){
	...
	cout<<"OpticalTracker tracking..."<<endl;
...
int OpticalTracker::readem(string filename){
	ifstream infile(filename);
	...
	cout<<"OpticalTracker tracking pivot..."<<endl;
